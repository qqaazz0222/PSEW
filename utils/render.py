...
def create_scene(img_pil, l_mesh, l_face, rot, color=None, metallicFactor=0., roughnessFactor=0.5, focal=600):
    color_list = []
    ...
    for i, mesh in enumerate(l_mesh):
        ...
        # mesh.apply_transform(trimesh.transformations.euler_matrix(-0.5, 0, 0, 'sxyz'))
    ...
    transform = OPENCV_TO_OPENGL_CAMERA_CONVENTION @ aspect_ratio
